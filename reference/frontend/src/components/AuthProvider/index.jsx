...
function AuthProvider({ children }) {
  ...
  useEffect(() => { 
    ...
    axiosInstance.get("/auth")
      ...
      .catch(error => {
        console.log(error);
        alert("Global Review: Fatal Error unable to get auth provider information from server. This can occur if there is an issue with the installation or the configuration has changed. Please ask your administrator to check the logs.");
      });
  }, [ampConfigured]);
