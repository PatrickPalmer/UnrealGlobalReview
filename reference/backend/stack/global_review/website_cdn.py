...
def create_website_and_cdn(
    ...
    *, 
    ...
    hosting_bucket = s3.Bucket(stack, 'GlobalReview-Frontend-Bucket', 
    ...
    distribution = cdn.Distribution(stack, 'GlobalReview-Cloudfront-Distribution', 
        ...
        additional_behaviors={
            '/api/*': cdn.BehaviorOptions(
                ...
                viewer_protocol_policy=cdn.ViewerProtocolPolicy.REDIRECT_TO_HTTPS,
                compress=False,
                cache_policy=cdn.CachePolicy(stack, 'GlobalReview-RestApiCachePolicy',
                    ...
                    cache_policy_name='GlobalReview-ApiGwWithAuthorization',
                ...
                origin_request_policy=cdn.OriginRequestPolicy(stack, 'GlobalReview-RestApiOriginRequestPolicy', 
                    ...
                    origin_request_policy_name='GlobalReview-ApiGwWithAuthorization',
                )
            )
        },
    )
    ...
    deploy_role = iam.Role(stack, 'GlobalReview-Bucket-Deployment-Role', 
    ...
    bucket_deployment = s3_deploy.BucketDeployment(stack, 'GlobalReview-Bucket-Deployment',
    ...
    return distribution, hosting_bucket
