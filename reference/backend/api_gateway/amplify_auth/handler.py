...
def lambda_handler(event, context):
    ...
    response = ssm_client.get_parameter(Name=f"/GlobalReview/Config/CdnDomainUrl")
    cdn_domain_url = response['Parameter']['Value']

    response = ssm_client.get_parameter(Name=f"/GlobalReview/Config/CognitoDomainName")
